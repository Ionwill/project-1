...
import org.springframework.web.bind.annotation.ExceptionHandler;
	...
	public class GlobalExceptionHandler {
		...
		@ExceptionHandler(BuggNotFoundException.class)
		public ResponseEntity<String> handleBuggNotFoundException(AuthorizationException e) {
			LOG.debug("Authorization exception was handled.", e);
			return new ResponseEntity<>("No bugg found", HttpStatus.UNAUTHORIZED);
		}
	}
